package ani.streamix.connections.anilist.api
...
class Query {
    ...
    data class Viewer(
        ...
        data class Data(
            @SerialName("Viewer")
            val user: ani.streamix.connections.anilist.api.User?
        )
    }
    ...
    data class Media(
        ...
        data class Data(
            @SerialName("Media")
            val media: ani.streamix.connections.anilist.api.Media?,
            @SerialName("Page")
            val page: ani.streamix.connections.anilist.api.Page?
        )
    }
...
//    ){
//        data class Data(
//            val AiringSchedule: ani.streamix.connections.anilist.api.AiringSchedule?
//        )
//    }
    ...
    data class Character(
        ...
        data class Data(
            ...
            val character: ani.streamix.connections.anilist.api.Character?
        )
    }
    ...
    data class Studio(
        ...
        data class Data(
            @SerialName("Studio")
            val studio: ani.streamix.connections.anilist.api.Studio?
        )
    }
...
//    ){
//        data class Data(
//            val MediaList: ani.streamix.connections.anilist.api.MediaList?
//        )
//    }
    ...
    data class MediaListCollection(
        ...
        data class Data(
            ...
            val mediaListCollection: ani.streamix.connections.anilist.api.MediaListCollection?
        )
    }
    ...
    data class CombinedMediaListResponse(
        ...
        @Serializable
        data class Data(
            @SerialName("current") val current: ani.streamix.connections.anilist.api.MediaListCollection?,
            @SerialName("planned") val planned: ani.streamix.connections.anilist.api.MediaListCollection?,
            @SerialName("repeating") val repeating: ani.streamix.connections.anilist.api.MediaListCollection?,
        )
    }
    ...
    data class HomePageMedia(
        ...
        @Serializable
        data class Data(
            @SerialName("currentAnime") val currentAnime: ani.streamix.connections.anilist.api.MediaListCollection?,
            @SerialName("repeatingAnime") val repeatingAnime: ani.streamix.connections.anilist.api.MediaListCollection?,
            @SerialName("favoriteAnime") val favoriteAnime: ani.streamix.connections.anilist.api.User?,
            @SerialName("plannedAnime") val plannedAnime: ani.streamix.connections.anilist.api.MediaListCollection?,
            @SerialName("currentManga") val currentManga: ani.streamix.connections.anilist.api.MediaListCollection?,
            @SerialName("repeatingManga") val repeatingManga: ani.streamix.connections.anilist.api.MediaListCollection?,
            @SerialName("favoriteManga") val favoriteManga: ani.streamix.connections.anilist.api.User?,
            @SerialName("plannedManga") val plannedManga: ani.streamix.connections.anilist.api.MediaListCollection?,
            @SerialName("recommendationQuery") val recommendationQuery: ani.streamix.connections.anilist.api.Page?,
            @SerialName("recommendationQueryNew") val recommendationQueryNew: ani.streamix.connections.anilist.api.Page? = null,
            @SerialName("recommendationPlannedQueryAnime") val recommendationPlannedQueryAnime: ani.streamix.connections.anilist.api.MediaListCollection?,
            @SerialName("recommendationPlannedQueryManga") val recommendationPlannedQueryManga: ani.streamix.connections.anilist.api.MediaListCollection?,
            @SerialName("missingSequelsCompletedQuery") val missingSequelsCompletedQuery: ani.streamix.connections.anilist.api.MediaListCollection?,
            @SerialName("missingSequelsAllListQuery") val missingSequelsAllListQuery: ani.streamix.connections.anilist.api.MediaListCollection? = null,
    ...
    data class RecommendationsResponse(
        ...
        @Serializable
        data class Data(
            @SerialName("recRating") val recRating: ani.streamix.connections.anilist.api.Page?,
            @SerialName("recNew") val recNew: ani.streamix.connections.anilist.api.Page? = null
        )
    }
    ...
    data class AnimeList(
        ...
        @Serializable
        data class Data(
            @SerialName("recentUpdates") val recentUpdates: ani.streamix.connections.anilist.api.Page?,
            @SerialName("trendingMovies") val trendingMovies: ani.streamix.connections.anilist.api.Page?,
            @SerialName("topRated") val topRated: ani.streamix.connections.anilist.api.Page?,
            @SerialName("mostFav") val mostFav: ani.streamix.connections.anilist.api.Page?,
            @SerialName("trending") val trending: ani.streamix.connections.anilist.api.Page? = null,
            @SerialName("popular") val popular: ani.streamix.connections.anilist.api.Page? = null,
        )
    }
    ...
    data class MangaList(
        ...
        @Serializable
        data class Data(
            @SerialName("trendingManga") val trendingManga: ani.streamix.connections.anilist.api.Page?,
            @SerialName("trendingManhwa") val trendingManhwa: ani.streamix.connections.anilist.api.Page?,
            @SerialName("trendingNovel") val trendingNovel: ani.streamix.connections.anilist.api.Page?,
            @SerialName("topRated") val topRated: ani.streamix.connections.anilist.api.Page?,
            @SerialName("mostFav") val mostFav: ani.streamix.connections.anilist.api.Page?,
            @SerialName("trending") val trending: ani.streamix.connections.anilist.api.Page? = null,
            @SerialName("popular") val popular: ani.streamix.connections.anilist.api.Page? = null,
    ...
    data class FollowerPage(
        ...
        val followers: List<ani.streamix.connections.anilist.api.User>?
    ) : java.io.Serializable

    @Serializable
    data class FollowingPage(
        @SerialName("following")
        val following: List<ani.streamix.connections.anilist.api.User>?
    ) : java.io.Serializable
