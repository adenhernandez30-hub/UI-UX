package ani.streamix.widgets.statistics
...
import ani.streamix.util.BitmapUtil.downloadImageAsBitmap
...
class ProfileStatsWidget : AppWidgetProvider() {
    ...
    companion object {
        ...
        fun getPrefsName(appWidgetId: Int) = "ani.streamix.widgets.Statistics.${appWidgetId}"
