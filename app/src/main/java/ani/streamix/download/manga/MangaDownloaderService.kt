package ani.streamix.download.manga
...
import ani.streamix.media.manga.ImageData
import ani.streamix.media.manga.MangaReadFragment.Companion.ACTION_DOWNLOAD_FAILED
import ani.streamix.media.manga.MangaReadFragment.Companion.ACTION_DOWNLOAD_FINISHED
import ani.streamix.media.manga.MangaReadFragment.Companion.ACTION_DOWNLOAD_PROGRESS
import ani.streamix.media.manga.MangaReadFragment.Companion.ACTION_DOWNLOAD_STARTED
import ani.streamix.media.manga.MangaReadFragment.Companion.EXTRA_CHAPTER_NUMBER
import ani.streamix.media.manga.MangaReadFragment.Companion.EXTRA_DOWNLOADED_BYTES
import ani.streamix.media.manga.MangaReadFragment.Companion.EXTRA_ESTIMATED_TOTAL_BYTES
import ani.streamix.snackString
import ani.streamix.util.Logger
import ani.streamix.util.NumberConverter.Companion.ofLength
import ani.streamix.util.SizeFormatter
...
class MangaDownloaderService : Service() {
    ...
    private suspend fun processQueueLoop() {
        ...
        while (serviceScope.isActive) {
            ...
            if (task != null) {
                if (PrefManager.getVal<Boolean>(PrefName.DownloadWifiOnly) && !ani.streamix.isWifiConnected(this@MangaDownloaderService)) {
