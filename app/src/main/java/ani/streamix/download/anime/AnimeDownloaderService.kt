package ani.streamix.download.anime
...
import ani.streamix.defaultHeaders
...
import ani.streamix.download.video.DrmDownloader
import ani.streamix.download.anime.AnimeDownloaderService.AnimeDownloadTask.Companion.getTaskName
...
class AnimeDownloaderService : Service() {
    ...
    private suspend fun processQueueLoop() {
        ...
        while (serviceScope.isActive) {
            ...
            if (task != null) {
                if (PrefManager.getVal<Boolean>(PrefName.DownloadWifiOnly) && !ani.streamix.isWifiConnected(this@AnimeDownloaderService)) {
