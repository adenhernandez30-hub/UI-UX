package ani.streamix.download.novel
...
import ani.streamix.parsers.novel.LnReaderNovelParser
...
class NovelDownloaderService : Service() {
    ...
    private suspend fun processQueueLoop() {
        ...
        while (serviceScope.isActive) {
            ...
            if (task != null) {
                if (PrefManager.getVal<Boolean>(PrefName.DownloadWifiOnly) && !ani.streamix.isWifiConnected(this@NovelDownloaderService)) {
    ...
    data class DownloadTask(
        ...
        val retries: Int = 2,
        val lnReaderParser: ani.streamix.parsers.novel.LnReaderNovelParser? = null,
    )
