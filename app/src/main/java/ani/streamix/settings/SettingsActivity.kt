...
class SettingsActivity : AppCompatActivity() {
    ...
    override fun onCreate(savedInstanceState: Bundle?) {
        ...
        binding.apply {
            ...
            val searchAdapter = ani.streamix.settings.search.SettingsSearchAdapter(emptyList())
            ...
            settingsSearchBarText.addTextChangedListener(object : android.text.TextWatcher {
                ...
                override fun onTextChanged(s: CharSequence?, start: Int, before: Int, count: Int) {
                    ...
                    if (query.isNotEmpty()) {
                        val results = ani.streamix.settings.search.SettingsRegistry.search(context, query)
