...
import ani.streamix.connections.anilist.Anilist.activityMergeTimeMap
import ani.streamix.connections.anilist.Anilist.rowOrderMap
import ani.streamix.connections.anilist.Anilist.scoreFormats
import ani.streamix.connections.anilist.Anilist.staffNameLang
import ani.streamix.connections.anilist.Anilist.titleLang
import ani.streamix.connections.anilist.AnilistMutations
import ani.streamix.connections.anilist.api.ScoreFormat
import ani.streamix.connections.anilist.api.UserStaffNameLanguage
import ani.streamix.connections.anilist.api.UserTitleLanguage
import ani.streamix.databinding.ActivitySettingsAnilistBinding
import ani.streamix.initActivity
import ani.streamix.navBarHeight
import ani.streamix.restartApp
        ...
        binding.settingsRecyclerView2.adapter = SettingsAdapter(
            arrayListOf(
                Settings(
                    ...
                    onClick = {
                        startActivity(
                            Intent(this, ani.streamix.util.ActivityMarkdownCreator::class.java).apply {
                                putExtra("type", "bio")
                            }
                        )
                    }
