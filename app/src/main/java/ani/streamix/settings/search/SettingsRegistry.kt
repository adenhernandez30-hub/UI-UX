package ani.streamix.settings.search
...
import ani.streamix.settings.AnilistSettingsActivity
import ani.streamix.settings.FAQActivity
import ani.streamix.settings.PlayerSettingsActivity
import ani.streamix.settings.ReaderSettingsActivity
import ani.streamix.settings.SettingsAboutActivity
import ani.streamix.settings.SettingsAccountActivity
import ani.streamix.settings.SettingsAddonActivity
import ani.streamix.settings.SettingsAnimeActivity
import ani.streamix.settings.SettingsCommonActivity
import ani.streamix.settings.SettingsExtensionsActivity
import ani.streamix.settings.SettingsMangaActivity
import ani.streamix.settings.SettingsNotificationActivity
import ani.streamix.settings.SettingsThemeActivity
import ani.streamix.settings.TorrentSettingsActivity
import ani.streamix.settings.UserInterfaceSettingsActivity
