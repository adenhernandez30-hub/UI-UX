package ani.streamix.parsers

import android.app.Application
import ani.streamix.currContext
import ani.streamix.download.DownloadCompat.Companion.loadEpisodesCompat
import ani.streamix.download.DownloadCompat.Companion.loadSubtitleCompat
...
class OfflineAnimeParser : AnimeParser() {
    ...
    override suspend fun autoSearch(mediaObj: ani.streamix.media.Media): ShowResponse? {
