...
import ani.streamix.databinding.ItemCommentsBinding
import ani.streamix.getAppString
import ani.streamix.getThemeColor
import ani.streamix.loadImage
import ani.streamix.openImage
import ani.streamix.profile.ProfileActivity
import ani.streamix.setAnimation
import ani.streamix.snackString
import ani.streamix.util.ColorEditor.Companion.adjustColorForContrast
import ani.streamix.util.ColorEditor.Companion.getContrastRatio
        ...
        for (match in matches) {
            ...
            val clickableSpan = object : ClickableSpan() {
                override fun onClick(widget: View) {
                    val spoiler = spannable.getSpans(start, end, ani.streamix.others.SpoilerPlugin.RedditSpoilerSpan::class.java).firstOrNull()
