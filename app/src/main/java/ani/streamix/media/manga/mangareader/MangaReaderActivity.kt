package ani.streamix.media.manga.mangareader
...
import ani.streamix.GesturesListener
...
import ani.streamix.connections.updateProgress
import ani.streamix.currContext
import ani.streamix.databinding.ActivityMangaReaderBinding
...
import ani.streamix.media.MediaSingleton
import ani.streamix.media.manga.MangaCache
import ani.streamix.media.manga.MangaChapter
import ani.streamix.media.emptyMedia
import ani.streamix.notifications.subscription.SubscriptionHelper
import ani.streamix.others.ImageViewDialog
import ani.streamix.parsers.HMangaSources
import ani.streamix.parsers.MangaImage
...
import ani.streamix.download.manga.MangaDownloaderService
import ani.streamix.download.manga.MangaServiceDataSingleton
import ani.streamix.media.MediaType
import ani.streamix.parsers.OfflineMangaParser
import ani.streamix.parsers.MangaParser
import ani.streamix.parsers.DynamicMangaParser
import uy.kohesive.injekt.Injekt
import uy.kohesive.injekt.api.get
import ani.streamix.settings.CurrentReaderSettings
import ani.streamix.settings.CurrentReaderSettings.Companion.applyWebtoon
import ani.streamix.settings.CurrentReaderSettings.Directions.BOTTOM_TO_TOP
import ani.streamix.settings.CurrentReaderSettings.Directions.LEFT_TO_RIGHT
import ani.streamix.settings.CurrentReaderSettings.Directions.RIGHT_TO_LEFT
import ani.streamix.settings.CurrentReaderSettings.Directions.TOP_TO_BOTTOM
import ani.streamix.settings.CurrentReaderSettings.DualPageModes.Automatic
import ani.streamix.settings.CurrentReaderSettings.DualPageModes.Force
import ani.streamix.settings.CurrentReaderSettings.DualPageModes.No
import ani.streamix.settings.CurrentReaderSettings.Layouts.CONTINUOUS_PAGED
import ani.streamix.settings.CurrentReaderSettings.Layouts.PAGED
import ani.streamix.settings.saving.PrefManager
import ani.streamix.settings.saving.PrefName
import ani.streamix.showSystemBarsRetractView
import ani.streamix.snackString
import ani.streamix.themes.ThemeManager
import ani.streamix.tryWith
...
import ani.streamix.media.manga.mangareader.BaseImageAdapter.Companion.loadBitmap
...
class MangaReaderActivity : AppCompatActivity() {
    ...
    override fun onDestroy() {
        ...
        ani.streamix.widgets.continue_widget.ContinueWidget.updateReadingState(this, null, null, null, isExiting = true)
                ...
                scope.launch(Dispatchers.IO) {
                    ...
                    if (loadedBitmap != null) {
                        ...
                        withContext(Dispatchers.Main) {
                            ani.streamix.media.manga.mangareader.ocr.OcrTranslationBottomSheet.newInstance(softwareBitmap)
    ...
    fun applySettings() {
        ...
        if (chapImages.isNotEmpty()) {
            ...
            ani.streamix.widgets.continue_widget.ContinueWidget.updateReadingState(
                this,
                media.userPreferredName,
                media.cover,
    ...
    private fun checkSmartDownloadManga(currentChapter: MangaChapter) {
        ...
        scope.launch(Dispatchers.IO) {
            try {
                ...
                ani.streamix.util.Logger.log("SmartDownloadManga error: ${e.message}")
            }
        }
    }
}
