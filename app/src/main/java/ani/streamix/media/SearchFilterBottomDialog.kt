...
import ani.streamix.databinding.BottomSheetSearchFilterBinding
...
class SearchFilterBottomDialog : BottomSheetDialogFragment() {
    ...
    override fun onViewCreated(view: View, savedInstanceState: Bundle?) {
        ...
        val rescueMode: Boolean = ani.streamix.settings.saving.PrefManager.getVal(
            ani.streamix.settings.saving.PrefName.RescueMode
        )
        if (rescueMode) {
        ...
        binding.searchFilterApply.setOnClickListener {
            val isRescueModeApply: Boolean = ani.streamix.settings.saving.PrefManager.getVal(
                ani.streamix.settings.saving.PrefName.RescueMode
            )
            activity.aniMangaResult.apply {
