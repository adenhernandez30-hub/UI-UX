...
import ani.streamix.connections.anilist.api.MediaExternalLink
import ani.streamix.connections.anilist.api.ExternalLinkType
import ani.streamix.connections.anilist.api.MediaList
import ani.streamix.connections.anilist.api.MediaStreamingEpisode
import ani.streamix.connections.anilist.api.MediaType
import ani.streamix.connections.anilist.api.Query
import ani.streamix.connections.mal.MAL
import ani.streamix.connections.mal.MalAnimeNode
import ani.streamix.connections.mal.MalListEntry
import ani.streamix.connections.mal.JikanMediaData
import ani.streamix.connections.mal.JikanBroadcast
import ani.streamix.connections.mal.JikanRelationEntry
import ani.streamix.media.anime.Anime
import ani.streamix.media.manga.Manga
...
import ani.streamix.connections.anilist.api.Media as ApiMedia
...
data class Media(
    ...
    @Transient var recommendationList: ArrayList<ani.streamix.connections.anilist.api.Recommendation>? = null,
    @Transient var stats: ani.streamix.connections.anilist.api.MediaStats? = null,
    @Transient var rankings: List<ani.streamix.connections.anilist.api.MediaRank>? = null,
        ...
        withContext(Dispatchers.IO) {
            this@deleteFromList?.let { media ->
                if (rescueMode) {
                    ...
                    val pending = ani.streamix.connections.PendingDeletion(
                        mediaId = media.id,
                        idMAL = media.idMAL,
                        isAnime = media.anime != null,
                    )
                    val existing: List<ani.streamix.connections.PendingDeletion> =
