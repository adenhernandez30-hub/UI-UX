...
class NovelReadAdapter(
        ...
        if (isLocal) {
            ...
            fun updateLayoutForSource(idx: Int) {
                val isLnReader = idx in 0 until novelReadSources.names.size
                        && novelReadSources[idx] is ani.streamix.parsers.novel.LnReaderNovelParser
                if (isLnReader) {
                    binding.searchBar.visibility = View.GONE
                    binding.divider.visibility = View.GONE
            ...
            binding.wrongTitleButton.setOnClickListener {
                val dialog = ani.streamix.media.SourceSearchDialogFragment().apply {
                    isNovel = true
                    media = fragment.media
                    onSourceSelected = { selected ->
                        val isLnReader = fragment.model.novelSources[fragment.source] is ani.streamix.parsers.novel.LnReaderNovelParser
                        if (isLnReader) {
            ...
            if (fragment.media.format == "LOCAL") {
                ...
                mediaDownloadTop.setOnClickListener {
                    fragment.requireContext().customAlertDialog().apply {
                        ...
                        val input = View.inflate(ani.streamix.currContext(), R.layout.dialog_layout, null)
                        ...
                        setPosButton(R.string.ok) {
                            ...
                            if (value != null && value > 0) {
                                ...
                                ani.streamix.toast("Please enter a valid number")
                            }
                        }
            ...
            resetProgress.setOnClickListener {
                fragment.requireContext().customAlertDialog().apply {
                    ...
                    setPosButton(R.string.ok) {
                        ...
                        ani.streamix.snackString("Deleted the progress of Chapters for ${fragment.media.nameRomaji}")
                    }
    ...
    fun updateChips(limit: Int, names: Array<String>, arr: Array<Int>, selected: Int = 0) {
        ...
        if (binding != null) {
            ani.streamix.util.PaginationChipHelper.buildChips(
