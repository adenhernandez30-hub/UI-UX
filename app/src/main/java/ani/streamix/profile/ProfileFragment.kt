...
import ani.streamix.connections.anilist.ProfileViewModel
import ani.streamix.connections.anilist.api.Query
import ani.streamix.databinding.FragmentProfileBinding
import ani.streamix.media.Author
import ani.streamix.media.AuthorAdapter
import ani.streamix.media.Character
import ani.streamix.media.CharacterAdapter
import ani.streamix.media.Media
import ani.streamix.media.MediaAdaptor
import ani.streamix.openOrCopyAnilistLink
import ani.streamix.setBaseline
import ani.streamix.setSlideIn
import ani.streamix.setSlideUp
import ani.streamix.util.AniMarkdown.Companion.getFullAniHTML
