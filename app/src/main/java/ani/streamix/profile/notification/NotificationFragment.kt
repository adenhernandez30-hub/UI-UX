package ani.streamix.profile.notification
...
import ani.streamix.connections.anilist.api.Notification
import ani.streamix.databinding.FragmentNotificationsBinding
import ani.streamix.media.MediaDetailsActivity
import ani.streamix.notifications.comment.CommentStore
import ani.streamix.notifications.subscription.SubscriptionStore
import ani.streamix.profile.ProfileActivity
import ani.streamix.profile.activity.FeedActivity
import ani.streamix.profile.notification.NotificationFragment.Companion.NotificationType.COMMENT
import ani.streamix.profile.notification.NotificationFragment.Companion.NotificationType.MEDIA
import ani.streamix.profile.notification.NotificationFragment.Companion.NotificationType.ONE
import ani.streamix.profile.notification.NotificationFragment.Companion.NotificationType.SUBSCRIPTION
import ani.streamix.profile.notification.NotificationFragment.Companion.NotificationType.USER
...
class NotificationFragment : Fragment() {
    ...
    private suspend fun getList() {
        val list = when (type) {
            ...
            MEDIA -> getNotificationsFiltered(type = true) { it.media != null || it.notificationType == ani.streamix.connections.anilist.api.NotificationType.MEDIA_DELETION.value }
            USER -> getNotificationsFiltered { it.media == null && it.notificationType != ani.streamix.connections.anilist.api.NotificationType.RELATED_MEDIA_ADDITION.value }
    ...
    fun onClick(id: Int, optional: Int?, type: NotificationClickType) {
        val intent = when (type) {
            ...
            NotificationClickType.THREAD -> Intent(
                requireContext(),
                ani.streamix.forum.ThreadViewActivity::class.java
            ).apply {
